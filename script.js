(() => {
  async function fetchAnswer() {
    const KEY = "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"; // replace the text "key" (keep the quotation marks) with your API key from https://platform.openai.com/account/api-keys
